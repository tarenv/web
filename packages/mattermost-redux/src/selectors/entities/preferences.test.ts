...
describe('Selectors.Preferences', () => {
    ...
    describe('get theme', () => {
        it('default theme', () => {
            ...
            } as unknown as GlobalState)).toEqual(Preferences.THEMES.forest);
        });
        ...
        it('custom theme with missing colours', () => {
            ...
            } as GlobalState).mentionHighlightLink).toEqual(Preferences.THEMES.forest.mentionHighlightLink);
        });
        ...
        it('returns the "default" theme if the server-configured value is not present', () => {
            ...
            } as unknown as GlobalState).codeTheme).toEqual(Preferences.THEMES.forest.codeTheme);
        });
    });
