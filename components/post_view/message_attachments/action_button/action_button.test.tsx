...
describe('components/post_view/message_attachments/action_button.jsx', () => {
    const baseProps = {
        ...
        theme: Preferences.THEMES.forest as unknown as Theme,
    };
    ...
    test('should have correct styles when provided color from theme', () => {
        ...
        expect(buttonStyles).toHaveProperty('borderColor', changeOpacity(Preferences.THEMES.forest.onlineIndicator, 0.25));
        expect(buttonStyles).toHaveProperty('borderWidth', 2);
        expect(buttonStyles).toHaveProperty('color', Preferences.THEMES.forest.onlineIndicator);
    });
